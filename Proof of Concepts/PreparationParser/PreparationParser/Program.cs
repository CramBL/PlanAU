...
namespace PreparationParser
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var parallelParser = new ParallelPreparationTextParser();

            var parser = new PreparationTextParser();

            string [] descArray = initializeStringArray(1);
            string[] descArray2 = initializeStringArray(2);



            Dictionary<int, List<string>> LecturesWithItems = new();

            ListDictionary listDictionary = new();
            int LDindex = 0;
            listDictionary.Add(LDindex++, LecturesWithItems);
            ...
            for (int i = 0; i < iterations; i++)
            {
                ...
                foreach (var desc in descArray)
                {
                    listDictionary.Add(LDindex++, parser.ParseModuleTableOfContents(desc));
                }
                ...
                totalElapsedTimeSequential += stopWatch.ElapsedMilliseconds;
            ...
            Console.WriteLine($"Elapsed Time Parallel: {totalElapsedTimeParallel/1000} seconds");
            Console.WriteLine($"Average Time: {totalElapsedTimeParallel/(1000*iterations)} seconds");

            Console.WriteLine("===== Sequential =====");
            Console.WriteLine($"Elapsed Time Sequential: {totalElapsedTimeSequential/1000} seconds");
            Console.WriteLine($"Average Time: {totalElapsedTimeSequential/(1000*iterations)} seconds");
            ...
            //stopWatch.Stop();
            //Console.WriteLine("List Dictionary count = "+ listDictionary.Count);
            ...
            //var SoftwareDesignCourse = courseFormatter.DictionaryToCourseObject("SWD", LecturesWithItems);
            

        }

        private static string[] initializeStringArray(int arrayNo)
        {
            string rawtoc2 =
            ...
            var rawtoc3 = @"{""Modules"":[{""ModuleId"":19712,""Title"":""Week 4.1 | Software architecture - Getting Started"",""Modules"":[],""Topics"":[],""LastModifiedDate"":""2021-11-17T14:45:45.783Z"",""Description"":{""Text"":""This week and the next:\nThe next two weeks we will look at Software architecture.\nThe main subjects are:\n- What is software architecture?\n- The process of developing a software architecture.\n- How to document software architecture.\nPreparation:\nWatch this video \""Make Architecture Matter\"" with Martin Fowler: Link to Video on YouTube.\nRead the short article by Martin Fowler which is referenced in the video.Link: http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf\nWe will use .NET Application Architecture Guide, 2nd Edition as an introduction, it can be downloaded from here.\nRead chapter 1, 2 and 3 (only p. 19-21) and chapter 4 of .Net Application Architecture Guide (See reading guide below)."",""Html"":""<h2>This week and the next:</h2>\n<p>The&#160;next two weeks&#160;we will look at Software architecture.</p>\n<p>The main subjects are:</p>\n<p>- What is software architecture?</p>\n<p>- The process of developing a software architecture.</p>\n<p>- How to document software architecture.</p>\n<h2>Preparation:</h2>\n<p>Watch this video &quot;Make Architecture Matter&quot; with Martin Fowler:&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""https://www.youtube.com/watch?v=DngAZyWMGR0\"">Link</a>&#160;to Video on YouTube.</p>\n<p>Read the short article by Martin Fowler which is referenced in the video.<br/>Link:&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf\"">http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf</a></p>\n<p>We will use&#160;<strong>.NET&#160;Application Architecture Guide, 2nd Edition</strong>&#160;as an introduction, it can be downloaded from&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""https://brightspace.au.dk/d2l/common/dialogs/quickLink/quickLink.d2l?ou=27083&amp;type=coursefile&amp;fileId=csfiles%2fhome_dir%2fApplication_Architecture_Guide_v2.pdf\"">here</a>.</p>\n<p>Read chapter 1, 2 and 3 (only p. 19-21) and chapter 4 of .Net Application Architecture Guide (See reading guide below).</p>""}},{""ModuleId"":19714,""Title"":""Week 4.1 | Software architecture - Getting Started"",""Modules"":[],""Topics"":[],""LastModifiedDate"":""2021-11-17T14:45:45.783Z"",""Description"":{""Text"":""This week and the next:\nThe next two weeks we will look at Software architecture.\nThe main subjects are:\n- What is software architecture?\n- The process of developing a software architecture.\n- How to document software architecture.\nPreparation:\nWatch this video \""Make Architecture Matter\"" with Martin Fowler: Link to Video on YouTube.\nRead the short article by Martin Fowler which is referenced in the video.Link: http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf\nWe will use .NET Application Architecture Guide, 2nd Edition as an introduction, it can be downloaded from here.\nRead chapter 1, 2 and 3 (only p. 19-21) and chapter 4 of .Net Application Architecture Guide (See reading guide below)."",""Html"":""<h2>This week and the next:</h2>\n<p>The&#160;next two weeks&#160;we will look at Software architecture.</p>\n<p>The main subjects are:</p>\n<p>- What is software architecture?</p>\n<p>- The process of developing a software architecture.</p>\n<p>- How to document software architecture.</p>\n<h2>Preparation:</h2>\n<p>Watch this video &quot;Make Architecture Matter&quot; with Martin Fowler:&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""https://www.youtube.com/watch?v=DngAZyWMGR0\"">Link</a>&#160;to Video on YouTube.</p>\n<p>Read the short article by Martin Fowler which is referenced in the video.<br/>Link:&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf\"">http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf</a></p>\n<p>We will use&#160;<strong>.NET&#160;Application Architecture Guide, 2nd Edition</strong>&#160;as an introduction, it can be downloaded from&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""https://brightspace.au.dk/d2l/common/dialogs/quickLink/quickLink.d2l?ou=27083&amp;type=coursefile&amp;fileId=csfiles%2fhome_dir%2fApplication_Architecture_Guide_v2.pdf\"">here</a>.</p>\n<p>Read chapter 1, 2 and 3 (only p. 19-21) and chapter 4 of .Net Application Architecture Guide (See reading guide below).</p>""}},{""ModuleId"":19716,""Title"":""Week 4.1 | Software architecture - Getting Started"",""Modules"":[],""Topics"":[],""LastModifiedDate"":""2021-11-17T14:45:45.783Z"",""Description"":{""Text"":""This week and the next:\nThe next two weeks we will look at Software architecture.\nThe main subjects are:\n- What is software architecture?\n- The process of developing a software architecture.\n- How to document software architecture.\nPreparation:\nWatch this video \""Make Architecture Matter\"" with Martin Fowler: Link to Video on YouTube.\nRead the short article by Martin Fowler which is referenced in the video.Link: http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf\nWe will use .NET Application Architecture Guide, 2nd Edition as an introduction, it can be downloaded from here.\nRead chapter 1, 2 and 3 (only p. 19-21) and chapter 4 of .Net Application Architecture Guide (See reading guide below)."",""Html"":""<h2>This week and the next:</h2>\n<p>The&#160;next two weeks&#160;we will look at Software architecture.</p>\n<p>The main subjects are:</p>\n<p>- What is software architecture?</p>\n<p>- The process of developing a software architecture.</p>\n<p>- How to document software architecture.</p>\n<h2>Preparation:</h2>\n<p>Watch this video &quot;Make Architecture Matter&quot; with Martin Fowler:&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""https://www.youtube.com/watch?v=DngAZyWMGR0\"">Link</a>&#160;to Video on YouTube.</p>\n<p>Read the short article by Martin Fowler which is referenced in the video.<br/>Link:&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf\"">http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf</a></p>\n<p>We will use&#160;<strong>.NET&#160;Application Architecture Guide, 2nd Edition</strong>&#160;as an introduction, it can be downloaded from&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""https://brightspace.au.dk/d2l/common/dialogs/quickLink/quickLink.d2l?ou=27083&amp;type=coursefile&amp;fileId=csfiles%2fhome_dir%2fApplication_Architecture_Guide_v2.pdf\"">here</a>.</p>\n<p>Read chapter 1, 2 and 3 (only p. 19-21) and chapter 4 of .Net Application Architecture Guide (See reading guide below).</p>""}},{""ModuleId"":19718,""Title"":""Week 4.1 | Software architecture - Getting Started"",""Modules"":[],""Topics"":[],""LastModifiedDate"":""2021-11-17T14:45:45.783Z"",""Description"":{""Text"":""This week and the next:\nThe next two weeks we will look at Software architecture.\nThe main subjects are:\n- What is software architecture?\n- The process of developing a software architecture.\n- How to document software architecture.\nPreparation:\nWatch this video \""Make Architecture Matter\"" with Martin Fowler: Link to Video on YouTube.\nRead the short article by Martin Fowler which is referenced in the video.Link: http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf\nWe will use .NET Application Architecture Guide, 2nd Edition as an introduction, it can be downloaded from here.\nRead chapter 1, 2 and 3 (only p. 19-21) and chapter 4 of .Net Application Architecture Guide (See reading guide below)."",""Html"":""<h2>This week and the next:</h2>\n<p>The&#160;next two weeks&#160;we will look at Software architecture.</p>\n<p>The main subjects are:</p>\n<p>- What is software architecture?</p>\n<p>- The process of developing a software architecture.</p>\n<p>- How to document software architecture.</p>\n<h2>Preparation:</h2>\n<p>Watch this video &quot;Make Architecture Matter&quot; with Martin Fowler:&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""https://www.youtube.com/watch?v=DngAZyWMGR0\"">Link</a>&#160;to Video on YouTube.</p>\n<p>Read the short article by Martin Fowler which is referenced in the video.<br/>Link:&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf\"">http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf</a></p>\n<p>We will use&#160;<strong>.NET&#160;Application Architecture Guide, 2nd Edition</strong>&#160;as an introduction, it can be downloaded from&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""https://brightspace.au.dk/d2l/common/dialogs/quickLink/quickLink.d2l?ou=27083&amp;type=coursefile&amp;fileId=csfiles%2fhome_dir%2fApplication_Architecture_Guide_v2.pdf\"">here</a>.</p>\n<p>Read chapter 1, 2 and 3 (only p. 19-21) and chapter 4 of .Net Application Architecture Guide (See reading guide below).</p>""}},{""ModuleId"":19720,""Title"":""Week 4.1 | Software architecture - Getting Started"",""Modules"":[],""Topics"":[],""LastModifiedDate"":""2021-11-17T14:45:45.783Z"",""Description"":{""Text"":""This week and the next:\nThe next two weeks we will look at Software architecture.\nThe main subjects are:\n- What is software architecture?\n- The process of developing a software architecture.\n- How to document software architecture.\nPreparation:\nWatch this video \""Make Architecture Matter\"" with Martin Fowler: Link to Video on YouTube.\nRead the short article by Martin Fowler which is referenced in the video.Link: http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf\nWe will use .NET Application Architecture Guide, 2nd Edition as an introduction, it can be downloaded from here.\nRead chapter 1, 2 and 3 (only p. 19-21) and chapter 4 of .Net Application Architecture Guide (See reading guide below)."",""Html"":""<h2>This week and the next:</h2>\n<p>The&#160;next two weeks&#160;we will look at Software architecture.</p>\n<p>The main subjects are:</p>\n<p>- What is software architecture?</p>\n<p>- The process of developing a software architecture.</p>\n<p>- How to document software architecture.</p>\n<h2>Preparation:</h2>\n<p>Watch this video &quot;Make Architecture Matter&quot; with Martin Fowler:&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""https://www.youtube.com/watch?v=DngAZyWMGR0\"">Link</a>&#160;to Video on YouTube.</p>\n<p>Read the short article by Martin Fowler which is referenced in the video.<br/>Link:&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf\"">http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf</a></p>\n<p>We will use&#160;<strong>.NET&#160;Application Architecture Guide, 2nd Edition</strong>&#160;as an introduction, it can be downloaded from&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""https://brightspace.au.dk/d2l/common/dialogs/quickLink/quickLink.d2l?ou=27083&amp;type=coursefile&amp;fileId=csfiles%2fhome_dir%2fApplication_Architecture_Guide_v2.pdf\"">here</a>.</p>\n<p>Read chapter 1, 2 and 3 (only p. 19-21) and chapter 4 of .Net Application Architecture Guide (See reading guide below).</p>""}},{""ModuleId"":19722,""Title"":""Week 4.1 | Software architecture - Getting Started"",""Modules"":[],""Topics"":[],""LastModifiedDate"":""2021-11-17T14:45:45.783Z"",""Description"":{""Text"":""This week and the next:\nThe next two weeks we will look at Software architecture.\nThe main subjects are:\n- What is software architecture?\n- The process of developing a software architecture.\n- How to document software architecture.\nPreparation:\nWatch this video \""Make Architecture Matter\"" with Martin Fowler: Link to Video on YouTube.\nRead the short article by Martin Fowler which is referenced in the video.Link: http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf\nWe will use .NET Application Architecture Guide, 2nd Edition as an introduction, it can be downloaded from here.\nRead chapter 1, 2 and 3 (only p. 19-21) and chapter 4 of .Net Application Architecture Guide (See reading guide below)."",""Html"":""<h2>This week and the next:</h2>\n<p>The&#160;next two weeks&#160;we will look at Software architecture.</p>\n<p>The main subjects are:</p>\n<p>- What is software architecture?</p>\n<p>- The process of developing a software architecture.</p>\n<p>- How to document software architecture.</p>\n<h2>Preparation:</h2>\n<p>Watch this video &quot;Make Architecture Matter&quot; with Martin Fowler:&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""https://www.youtube.com/watch?v=DngAZyWMGR0\"">Link</a>&#160;to Video on YouTube.</p>\n<p>Read the short article by Martin Fowler which is referenced in the video.<br/>Link:&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf\"">http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf</a></p>\n<p>We will use&#160;<strong>.NET&#160;Application Architecture Guide, 2nd Edition</strong>&#160;as an introduction, it can be downloaded from&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""https://brightspace.au.dk/d2l/common/dialogs/quickLink/quickLink.d2l?ou=27083&amp;type=coursefile&amp;fileId=csfiles%2fhome_dir%2fApplication_Architecture_Guide_v2.pdf\"">here</a>.</p>\n<p>Read chapter 1, 2 and 3 (only p. 19-21) and chapter 4 of .Net Application Architecture Guide (See reading guide below).</p>""}},{""ModuleId"":19724,""Title"":""Week 4.1 | Software architecture - Getting Started"",""Modules"":[],""Topics"":[],""LastModifiedDate"":""2021-11-17T14:45:45.783Z"",""Description"":{""Text"":""This week and the next:\nThe next two weeks we will look at Software architecture.\nThe main subjects are:\n- What is software architecture?\n- The process of developing a software architecture.\n- How to document software architecture.\nPreparation:\nWatch this video \""Make Architecture Matter\"" with Martin Fowler: Link to Video on YouTube.\nRead the short article by Martin Fowler which is referenced in the video.Link: http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf\nWe will use .NET Application Architecture Guide, 2nd Edition as an introduction, it can be downloaded from here.\nRead chapter 1, 2 and 3 (only p. 19-21) and chapter 4 of .Net Application Architecture Guide (See reading guide below)."",""Html"":""<h2>This week and the next:</h2>\n<p>The&#160;next two weeks&#160;we will look at Software architecture.</p>\n<p>The main subjects are:</p>\n<p>- What is software architecture?</p>\n<p>- The process of developing a software architecture.</p>\n<p>- How to document software architecture.</p>\n<h2>Preparation:</h2>\n<p>Watch this video &quot;Make Architecture Matter&quot; with Martin Fowler:&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""https://www.youtube.com/watch?v=DngAZyWMGR0\"">Link</a>&#160;to Video on YouTube.</p>\n<p>Read the short article by Martin Fowler which is referenced in the video.<br/>Link:&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf\"">http://martinfowler.com/ieeeSoftware/whoNeedsArchitect.pdf</a></p>\n<p>We will use&#160;<strong>.NET&#160;Application Architecture Guide, 2nd Edition</strong>&#160;as an introduction, it can be downloaded from&#160;<a rel=\""noopener\"" target=\""_blank\"" href=\""https://brightspace.au.dk/d2l/common/dialogs/quickLink/quickLink.d2l?ou=27083&amp;type=coursefile&amp;fileId=csfiles%2fhome_dir%2fApplication_Architecture_Guide_v2.pdf\"">here</a>.</p>\n<p>Read chapter 1, 2 and 3 (only p. 19-21) and chapter 4 of .Net Application Architecture Guide (See reading guide below).</p>""}},{""ModuleId"":19726,""Title"":""Week 4.2 | Software Architecture - The tool box"",""Modules"":[],""Topics"":[],""LastModifiedDate"":""2021-11-17T14:46:02.827Z"",""Description"":{""Text"":""Preparation\nRead the rest of chapter 3 of the Microsoft Application Architecture Guide, p. 21-35.\nFinish the exercise from last time, and prepare/execute the next steps in VideoFlix exercise, as described at the last lecture.\nOptional background material about Architecting\nOptional: Watch this video presentation by Simon Brown: The Frustrated Architect (tip: you can select the video in 1.5x speed above the embedded view if you want to, it is quite long!) The slides are attached here:\nSimonBrown-TheFrustratedArchitect-slides.pdf"",""Html"":""<h3>Preparation</h3>\n<p>Read the rest of chapter 3 of the Microsoft Application Architecture Guide, p. 21-35.</p>\n<p>Finish the exercise from last time, and prepare/execute the next steps in VideoFlix exercise, as described at the last lecture.</p>\n<h3>Optional background material about Architecting</h3>\n<p>Optional: Watch this video presentation by Simon Brown:&#160;<a rel=\""noopener\"" href=\""https://www.infoq.com/presentations/The-Frustrated-Architect\"" target=\""_blank\"">The Frustrated Architect</a>&#160;(tip: you can select the video in 1.5x speed above the embedded view if you want to, it is quite long!) The slides are attached here:</p>\n<p><a rel=\""noopener\"" href=\""https://brightspace.au.dk//content/enforced/27083-LR2597/csfiles/home_dir/SimonBrown-TheFrustratedArchitect-slides.pdf?_&amp;d2lSessionVal=9JuJiCQdrrwKs25jQ5zPcfidC&amp;ou=27083\"" target=\""_blank\"">SimonBrown-TheFrustratedArchitect-slides.pdf</a></p>""}}]}";
            ...
            {
                rawtoc2, rawtoc3, rawtoc2+Big, rawtoc3, rawtoc3 + rawtoc2, rawtoc3 + rawtoc3 + rawtoc3,
                rawtoc3+rawtoc3+rawtoc2+"[£21321",
                rawtoc3+Big+rawtoc3+rawtoc2+"lort",
                rawtoc3+rawtoc3+rawtoc2+"random",
                rawtoc3+rawtoc3+rawtoc2+"ran"+rawtoc2,
                Big,
                Big,
                Big+Big+Big,
                Big,
            ...
            string[] descArray2 = new[]
            {
                rawtoc2, rawtoc3, rawtoc2 + Big, rawtoc3, rawtoc3 + rawtoc2, rawtoc3 + rawtoc3 + rawtoc3,
                rawtoc3 + rawtoc3 +Big2 + rawtoc2 + "[£21321",
                rawtoc3 + Big + rawtoc3 + rawtoc2 + "lort",
                rawtoc3 + rawtoc3 + rawtoc2 + "random",
                rawtoc3 + rawtoc3 + rawtoc2 + "ran" + rawtoc2,
                Big,
